...
class Test_Login_Excel_003:
    ...
    driver = None
    excel_path = r"C:\CredKart_Pytest_Framework\TestData\Test_Data.xlsx"
    ...
    def test_CredKart_Login_Excel_003(self):
        ...
        for i in range(2, self.rows + 1):
            ...
            if self.lp.verify_menu() == "Pass":
                ...
                self.driver.save_screenshot(r"C:\CredKart_Pytest_Framework\Screenshots\test_CredKart_Login_Excel_003_{i}_{self.email}_pass.png")
                ...
                self.log.info("Taking screenshot")
                self.driver.save_screenshot(r"C:\CredKart_Pytest_Framework\Screenshots\test_CredKart_Login_Excel_003_{i}_{self.email}_fail.png")
                actual_result = "Fail"
